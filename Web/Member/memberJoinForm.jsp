	 ...
	 <form id="joinForm" action="/win/mInsert.me" method="post">
         <div class="sign_form">
            ...
            <label class="control_label" for="user_email"><span class="star">*</span>이메일</label>
                ...
                <input class="requird_form" id="user_email" name="email" type="email"  placeholder="사용하실 이메일을 입력해주세요." required value="asdok97@naver.com">
        ...
        <div class="form_group">
            <label class="control_label" for="user_Name"><span class="star">*</span>이름(기업명)</label>
                <input class="requird_form" id="user_Name" name="userName" type="text" placeholder="이름(기업명)을 입력해주세요." required value="yejin">                
        </div>
       

        <div class="form_group">
            <label class="control_label" for="user_ID"><span class="star">*</span>아이디</label>
                <input class="requird_form" id="user_ID" name="userId" type="text" placeholder="사용하실 아이디를 입력해주세요." required value="asdok97">                
        </div>
        ...
        <div class="form_group1"  id="com_num">
            <label class="control_label" for="company_num"><span class="star">*</span>사업자번호</label>
                <input class="requird_form" id="company_num" name="companyId" type="text" placeholder="사업자 번호를 입력해주세요.(- 없이)" required value="1113933140">    
        </div>
        ...
        <div class="form_group">
            <label class="control_label" for="user_pwd"><span class="star">*</span>비밀번호</label>
                <input class="requird_form" id="user_pwd" name="userPwd" type="password"  placeholder="사용하실 비밀번호를 입력해주세요." required value="12121212">                
            <div class="form_group_caption">
        ...
        <div class="form_group">
            <label class="control_label" for="user_pwd1"><span class="star">*</span>비밀번호 확인</label>
                <input class="requird_form" id="user_pwd1" name="userPwd1" type="password" placeholder="비밀번호를 다시 입력해주세요." required value="12121212">    
            <div class="form_group_caption">
        ...
        <div class="terms_form1" >
            <input type="radio" name="clause" value="clause"><a href="use.html"><b>이용약관</b></a>에 동의합니다. <br>
        </div>
        <div class="terms_form2">
            <input type="radio" name="personalInfo" value="personalInfo"><a href="user.html"><b>개인정보 처리방침</b></a>에 동의합니다.
        </div>

        <div class="button">
            <input type="submit" value="회원가입" name="input_submit" class="input_field" style="width:325px;height:40px;margin-top: 30px;margin-bottom: 50px;">
        </div>
     </div>
    </div>
</div>
