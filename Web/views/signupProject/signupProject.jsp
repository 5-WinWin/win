...
<body>
    <nav>
        <ul>
            <li class="logo"><img src="/semi/resources/images/win_win.png"></li>
                        ...
                        <div class="projectmoney_choice">
                            <div class="money_choice_box">
                                <div class="choice_year">
                                    <select class="custom_choice_year" name = "cost">
                                ...
                                <div class="month_money">
                                    <input class="client_month_money" placeholder="1인당 월 실수령액">
                    ...
                    <div class="project_ing">
                            ...
                            <ul class="cpLing">
                                <li>
                                    <label class="input_ing">
                                        <input type="radio" name="ra_bu">상담 후 결정
                                    </label>
                                </li>
                                <li class="input_radioB">
                                    <label class="input_ing">
                                        <input type="radio" name="ra_bu">1주일 이내
                                    </label>
                                </li>
                                <li class="input_radioB">
                                    <label class="input_ing">
                                        <input type="radio" name="ra_bu">2주일 이내
                                    </label>
                                </li>
                                <li class="input_radioB">
                                    <label class="input_ing">
                                        <input type="radio" name="ra_bu">3주일 이내
                                    </label>
                                </li>
                                <li class="input_radioB">
                                    <label class="input_ing">
                                        <input type="radio" name="ra_bu">1개월 이내
                                    </label>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="choice_project_Ring">
                            <ul class="cpLing"> 
                                <li>
                                    <label class="input_ing">
                                        <input type="radio" name="ra_bu">2개월 이내
                                    </label>
                                </li>
                                <li class="input_radioB">
                                    <label class="input_ing">
                                        <input type="radio" name="ra_bu">3개월 이내
                                    </label>
                                </li>
                                <li class="input_radioB">
                                    <label class="input_ing">
                                        <input type="radio" name="ra_bu">4개월 이내
                                    </label>
                                </li>
                                <li class="input_radioB">
                                    <label class="input_ing">
                                        <input type="radio" name="ra_bu">5개월 이내
                                    </label>
                                </li>
                                <li class="input_radioB">
                                    <label class="input_ing">
                                        <input type="radio" name="ra_bu">6개월 이상
                                    </label>
                                </li>
                                <li class="input_radioB">
